use crate::{
    ...
    modules::{
        custom_command::CustomCommandsCommand, holiday::HolidayCommand, join::JoinCommand,
        massping::MasspingCommand, ping::PingCommand, spam::SpamCommand, timer::TimerCommand,
    },
    shared_variables::{
