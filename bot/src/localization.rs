...
pub enum LineId {
    ...
    ErrorNotRegisteredCommand,
    ErrorLuaExecutionError,
    ErrorLuaUnsupportedResponseType,
    ErrorLuaExceededWaitingTime,
...
impl LineId {
    pub fn from_string(value: String) -> Option<Self> {
        match value.as_str() {
            ...
            "error.not_registered_command" => Some(Self::ErrorNotRegisteredCommand),
            "error.lua.execution_error" => Some(Self::ErrorLuaExecutionError),
            "error.lua.unsupported_response_type" => Some(Self::ErrorLuaUnsupportedResponseType),
            "error.lua.exceeded_waiting_time" => Some(Self::ErrorLuaExceededWaitingTime),
